import { getGoods, getUsers, addGood, updateGood, deleteGood, deleteUser, updateUser, addUser } from './api.js'
...
function resetUserForm() {
    ...
    document.getElementById('submitUserBtn').textContent = 'Добавить пользователя';
